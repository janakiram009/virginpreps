...
class Command(BaseCommand):
    help = "Create product categories from a predefined list of breadcrumbs"

    def handle(self, *args, **kwargs):
        self.stdout.write(f"DEBUG value: {settings.DEBUG}")
        ...
        for breadcrumbs in categories:
            ...
            self.stdout.write(f"Created category: {breadcrumbs}")
